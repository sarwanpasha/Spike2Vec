...
#arr_all_datasets = [100000,200000]
...
for clust_ind in range(len(number_of_clusters)):
    ...
    write_path_11 = "/alina-data1/sarwan/IEEE_BigData/Dataset/new_freq_vec_hard_kmeans_clustering_k_" + str(clust_num) + ".csv"
    ...
    write_path_11 = "/alina-data1/sarwan/IEEE_BigData/Dataset/new_attributes_freq_vec_hard_kmeans_clustering_k_" + str(clust_num) + ".csv"
    with open(write_path_11, 'w', newline='') as file:
        writer = csv.writer(file)
